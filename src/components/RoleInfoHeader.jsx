        ...
        <div className="bg-white relative">
            <div className="container mx-auto px-10">
                ...
                <div className="w-[40vw] md:w-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0">
                    <div className="w-16 h-16 bg-white blur-[65px] animate-blob1" />
                    <div className="w-16 h-16 bg-indigo-200 blur-[65px] animate-blob2" />
                    <div className="w-16 h-16 bg-cyan-400 blur-[50px] animate-blob3" />
                    <div className="w-16 h-16 bg-indigo-300 blur-[45px] animate-blob4" />
                </div>
            </div>
        </div>
    )
