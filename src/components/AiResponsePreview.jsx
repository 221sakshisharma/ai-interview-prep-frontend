          ...
          components={{
            code({node, className, children, ...props}) {
              ...
              return !isInline? (
                ...
                <span className='px-1 py-0.5 rounded-sm bg-gray-100 text-gray-950 text-xs font-semibold tracking-wide' {...props}>
                  {children}
                </span>
              )
            ...
            td: ({ children }) => (
              <td className="my-1 text-gray-800">
                {children}
              </td>
            ),
            th: ({ children }) => (
            ...
            tr: ({ children }) => (
              <tr className="px-3 py-2 whitespace-nowrap text-sm">
                {children}
              </tr>
            ),
